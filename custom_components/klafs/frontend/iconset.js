/**
 * Klafs Custom Icon Set - ha-iconset-svg (Web Components)
 * Official Home Assistant method for custom icons
 * Complete SVG definitions embedded inline (no external files needed)
 */

(() => {
  // Create template with ha-iconset-svg Web Component
  const template = document.createElement('template');
  template.innerHTML = `
    <ha-iconset-svg name="klafs" size="24">
      <svg><defs>
        <!-- sauna: Default sauna icon with thermometer at 50% -->
        <g id="sauna">
        ...
        <!-- sauna-heating: Sauna heating up with heat waves and thermometer at 50% -->
        <g id="sauna-heating">
          <rect x="9" y="15" width="6" height="3" rx="0.5" fill="currentColor"/>
          <rect x="9.8" y="15.5" width="0.4" height="2" fill="#888"/>
          <rect x="10.8" y="15.5" width="0.4" height="2" fill="#888"/>
        ...
        <!-- sauna-ready: Sauna ready with checkmark and thermometer at 100% -->
        <g id="sauna-ready">
          <rect x="9" y="15" width="6" height="3" rx="0.5" fill="currentColor"/>
          <rect x="9.8" y="15.5" width="0.4" height="2" fill="#888"/>
          <rect x="10.8" y="15.5" width="0.4" height="2" fill="#888"/>
        ...
        <!-- sauna-off: Sauna off with reduced opacity and thermometer at 0% -->
        <g id="sauna-off">
  ...
  console.info('[Klafs Icons] ha-iconset-svg registered: sauna, sauna-heating, sauna-ready, sauna-off');
})();
