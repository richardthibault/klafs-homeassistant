...
**Lire dans d'autres langues :** [English](README.md) | **Français** | [Deutsch](README.de.md) | [Español](README.es.md)
...
Voir [EXAMPLES.md](EXAMPLES.md) pour plus d'exemples d'automatisations et de cartes Lovelace.
...
- 🏗️ [Support multi-saunas](MULTI_SAUNA_SUPPORT.md)
...
Pour plus d'aide, consultez le [Guide de dépannage](TROUBLESHOOTING.md).
